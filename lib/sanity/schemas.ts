// Sanity schema definitions for Latina Empire content

// Event schema for Sanity
...
// Export all schemas
export const schemas = [eventSchema, ambassadorSchema, blogPostSchema]