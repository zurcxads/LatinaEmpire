      ...
      <section className="min-h-[100vh] flex flex-col justify-center relative overflow-hidden bg-black text-white">
        <div className="container mx-auto px-4 md:px-10 z-10">
          <div className="relative w-full max-w-6xl mx-auto">
            ...
            <div className="absolute inset-4 md:inset-8 lg:inset-12 overflow-hidden rounded-2xl shadow-2xl
              ...
              <img 
                ...
                className="w-full h-full object-cover relative z-[5] transform transition-all duration-700 hover:scale-105"
              />
