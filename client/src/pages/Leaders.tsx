...
const LeaderCard = ({ ambassador }: { ambassador: Ambassador }) => {
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-md hover:shadow-lg group">
      ...
      <div className="p-6">
        ...
        <Link href={`/leaders/${ambassador.slug}`}>
...
const Leaders = () => {
  // Fetch ambassadors data with React Query (still using the same API)
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12 border border-red-200 rounded-lg p-8 bg-red-50 shadow-md">
              ...
              <p className="text-gray-700 mb-4">
                We're having trouble loading our community leaders. Please refresh the page or check back later.
              </p>
              <Button 
            ...
            // Display leaders
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredLeaders.map((ambassador: Ambassador) => (
                <LeaderCard key={ambassador.id} ambassador={ambassador} />
              ))}
            </div>
          ) : (
            // No leaders available
            <div className="text-center py-12 border border-gray-200 rounded-lg p-8 bg-gray-50 shadow-md">
              <h3 className="font-serif font-semibold text-xl mb-2 text-gray-800">No Leaders Yet</h3>
              <p className="text-gray-600 mb-4">
                We're in the process of adding our community leaders. Check back soon!
              </p>
            </div>
          )}
        </div>
